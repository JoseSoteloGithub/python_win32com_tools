...
# Returns last column letter
    if header_row_int != 0:
        last_column_letter_range = worksheet_obj.Rows(header_row_int).Find(What='*', SearchOrder=constants.xlByColumns, SearchDirection=constants.xlPrevious)
    else:
        last_column_letter_range = worksheet_obj.Cells.Find(What='*', SearchOrder=constants.xlByColumns, SearchDirection=constants.xlPrevious)
    if last_column_letter_range is not None:
        last_column_letter_address = last_column_letter_range.Address
